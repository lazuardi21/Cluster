...
! function (t, n) {
        ...
        lineEnd: function () {
            ...
            if (e)
                if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]);
                    ...
                    for (var r = Bm(t), i = Bm(n), o = 0, a = 1; a < e; ++o, ++a) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[a], n[a]);
    ...
    tx.prototype = Qm.prototype, t.Adder = g, t.Delaunay = nu, t.FormatSpecifier = uc, t.InternMap = y, t.InternSet = v, t.Voronoi = Wa, t.active = function (t, n) {
        ...
        function i(i) {
            var o, a, u = Array.from(t.apply(this, arguments), Xm),
                c = u.length,
                f = -1;
            for (const t of i)
        ...
        return y.transform = function (t, n, e, r) {
            ...
            return arguments.length ? (i = "function" == typeof t ? t : Zm([
                [+t[0][0], +t[0][1]],
                [+t[1][0], +t[1][1]]
            ]), y) : i
    ...
    }, t.zoomIdentity = Jm, t.zoomTransform = tx, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}));